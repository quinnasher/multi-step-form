...
function FormLayout({ children }) {
  ...
  return (
    <main className={" relative md:min-w-min min-w-[300px] h-[940px] md:h-screen bg-white md:bg-nMagnolia flex justify-center md:items-center"}>
      <div className={" relative bg-nMagnolia md:bg-nWhite w-full flex flex-col   md:shadow-lg md:flex-row  h-[70%] md:w-[70%] md:rounded-lg md:justify-between md:h-[80%]"}>
        ...
        <div className={"absolute left-0 right-0 top-[7.1rem] md:static bg-nWhite w-[90%] md:w-[50%] md:shadow-none shadow-lg px-4 p-6 md:py-0 md:rounded-none rounded-lg md:px-0 mx-auto md:mt-12"}>
          {children}
        </div>
      </div>

      <div className={"absolute flex justify-between w-[90%] bottom-[11.5rem] md:w-[35.5%] md:bottom-[4.56rem] md:right-[16.68rem]"}>
