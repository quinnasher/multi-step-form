...
The designs are in JPG static format. Using JPGs will mean that you'll need to use your best judgment for btnStyle such
...
2. Configure your repository to publish your code to a web address. This will also be useful if you need some help
   during a challenge as you can share the URL for your project with your repo URL. There are a text of ways to do
...
3. Look through the designs to start planning out how you'll tackle the project. This step is crucial to help you think
   ahead for CSS classes to create reusable btnStyle.
4. Before adding any btnStyle, structure your content with HTML. Writing your HTML first can help focus your attention
   on
   creating well-structured content.
5. Write out the base btnStyle for your project, including general content btnStyle, such as `font-family`
   and `font-size`.
6. Start adding btnStyle to the top of the page and work down. Only move on to the next section once you're happy you've
...
FormSubmit your solution on the platform for the rest of the community to see. Follow
